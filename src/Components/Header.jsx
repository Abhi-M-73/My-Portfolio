...
export default function Header() {
  ...
  return (
    <>
      <header className="p-4 bg-[#333] text-white fixed w-full top-0 z-50 shadow-2xl">
        <nav className="flex justify-between items-center px-10">
          <h1 className="text-xl font-bold">Visual Designer</h1>

          {/* Desktop Menu */}
          <div className="hidden md:flex gap-12">
            <a href="#home" className="hover:text-red-500 hover:font-semibold border-b-2 pb-2 border-transparent hover:border-red-500 transition-all">Home</a>
            <a href="#about" className="hover:text-red-500 hover:font-semibold border-b-2 pb-2 border-transparent hover:border-red-500 transition-all">About</a>
            <a href="#projects" className="hover:text-red-500 hover:font-semibold border-b-2 pb-2 border-transparent hover:border-red-500 transition-all">Projects</a>
            <a href="#skills" className="hover:text-red-500 hover:font-semibold border-b-2 pb-2 border-transparent hover:border-red-500 transition-all">Skills</a>
            <a href="#experience" className="hover:text-red-500 hover:font-semibold border-b-2 pb-2 border-transparent hover:border-red-500 transition-all">Experience</a>
            <a href="#contact" className="hover:text-red-500 hover:font-semibold border-b-2 pb-2 border-transparent hover:border-red-500 transition-all">Contact</a>
          </div>

          {/* Desktop Resume Button */}
          <div className="hidden md:block">
            <a href="#resume" className="px-4 py-2 bg-red-500 rounded-md hover:bg-red-600 transition-all">Download Resume</a>
          </div>
